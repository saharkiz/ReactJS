...
import Mycoursebooking from '../../components/Mycoursebooking.js'
import { useHistory } from 'react-router-dom'
const View_course = ({match}) => {
  ...
  document.title="View User Course";
  return (
    <>
    <Mycoursebooking url={`https://admin.scubadiving.ae/api/getcourse.php?id=${match.params.id}`} />
    <CRow>
    <CCol lg={12}>
      <CCard>
          <CCardBody>
