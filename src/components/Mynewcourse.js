    ...
    constructor(props) {
      ...
      myAdd()
      {
        var myHeaders = new Headers();
            ...
            this.setState({showLoading: true  });
              fetch("https://admin.scubadiving.ae/api/newcourse.php", requestOptions)
      ...
      { //send email confirmation
        var myHeaders = new Headers();
            ...
            this.setState({showLoading: true  });
              fetch("https://admin.scubadiving.ae/api/sendemailcourse.php?id="+ this.state.data["id"], requestOptions)
              .then(response => response.text())
              .then(
                    json => 
                    {
